...
import type {
  ...
  ToastActionElement as RadixToastActionElement,
...
type ToastProps = RadixToastProps & VariantProps<typeof toastVariants>

type ToastActionElement = RadixToastActionElement
